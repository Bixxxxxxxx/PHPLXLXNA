...
<div class="koko1">
    <section class = "signup-form">
            ...
            <form action="include/signup.inc.php" method = "POST">
                ...
                <button type = "submit" name ="submit_student">Register as student</button>
                <button type = "submit" name ="submit_admin">Register as student admin</button>
                
            </form> 
            <a href="signup.admin.php">Go to signup as teacher</a>
